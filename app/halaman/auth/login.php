...
if (isset($_POST['submit'])) {
    ...
    $result = $mysqli->query("SELECT p.*, k.id AS id_kasir, k.nama FROM pengguna AS p LEFT JOIN kasir AS k ON p.id=k.id_pengguna WHERE p.username='$username' AND p.password='$password'");
    if($result->num_rows){
