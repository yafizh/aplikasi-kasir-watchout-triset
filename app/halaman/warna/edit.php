...
$result = $mysqli->query('SELECT * FROM warna WHERE id=' . $_GET['id']);
...
if (isset($_POST['submit'])) {
    ...
    if ($mysqli->query($q)) {
        echo "<script>sessionStorage.setItem('edit','Edit warna berhasil.')</script>";
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12 d-flex justify-content-between">
                                                <a href="?halaman=warna" class="btn btn-light-secondary mb-1">Kembali</a>
