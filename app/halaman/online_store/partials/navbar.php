        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-item mx-2 position-relative">
                    <div id="jumlah-keranjang">
                    </div>
                    <a class="nav-link <?= $active == 'keranjang' ? 'text-primary fw-bold' : 'text-dark'; ?>" href="keranjang.php">
                ...
                <li class="nav-item mx-2">
                    <a class="nav-link <?= $active == 'profil' ? 'text-primary fw-bold' : 'text-dark'; ?>" href="profil.php">
...
<?php if (isset($_SESSION['user']['pembeli'])) : ?>
    <input type="text" hidden name="id_pembeli" value="<?= $_SESSION['user']['pembeli']['id']; ?>">
<?php endif; ?>