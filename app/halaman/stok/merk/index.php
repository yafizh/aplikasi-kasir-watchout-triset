            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            <?php
                            $data = $mysqli->query("SELECT * FROM jenis_pakaian");
                            $no = 1;
                            ?>
                            <?php while ($row = $data->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td class="no-td">
                                        <a href="?halaman=stok_per_jenis&id_merk=<?= $_GET['id_merk']; ?>&id_jenis_pakaian=<?= $row['id']; ?>" class="btn btn-info btn-sm text-white"><i class="fas fa-eye"></i></a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
